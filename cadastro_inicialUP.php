    ...
    <form name="requerimento"> 
        <div class="step" id="step-2">
            ...
            <div>
                ...
                <button type="button" class="view-button <?php echo $result_d5 ? '' : 'disabled'; ?>" <?php echo $result_d5 ? 'onclick="window.open(\'uploads/' . $result_d5['vch_documento'] . '\', \'_blank\');"' : ''; ?>>
    ...
    <form id="uploadFormFoto"> 
        <div class="step" id="step-3">
            ...
            <div>
                ...
                <button type="button" class="view-button <?php echo $result_d1 ? '' : 'disabled'; ?>" <?php echo $result_d1 ? 'onclick="window.open(\'uploads/' . $result_d1['vch_documento'] . '\', \'_blank\');"' : ''; ?>>
                    Ver Foto Enviada
                </button>
            </div>
        </div>
    ...
    <form id="uploadFormIdentidade"> 
        <div class="step" id="step-4">
            ...
            <div>
                ...
                <button type="button" class="view-button <?php echo $result_d4 ? '' : 'disabled'; ?>" <?php echo $result_d4 ? 'onclick="window.open(\'uploads/' . $result_d4['vch_documento'] . '\', \'_blank\');"' : ''; ?>>
    ...
    <form id="uploadFormResidencia"> 
        <div class="step" id="step-5">
            ...
            <div>
                ...
                <button type="button" class="view-button <?php echo $result_d3 ? '' : 'disabled'; ?>" <?php echo $result_d3 ? 'onclick="window.open(\'uploads/' . $result_d3['vch_documento'] . '\', \'_blank\');"' : ''; ?>>
    ...
    <form id="uploadFormLaudo"> 
        <div class="step" id="step-6">
            ...
            <div>
                ...
                <button type="button" class="view-button <?php echo $result_d2 ? '' : 'disabled'; ?>" <?php echo $result_d2 ? 'onclick="window.open(\'uploads/' . $result_d2['vch_documento'] . '\', \'_blank\');"' : ''; ?>>
