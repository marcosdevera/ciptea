...
<body>
    <form name="form" action="processamento/processar_usuario.php" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" name="cid" id="cid" value="<?php echo $row_p['cid'] ?>">
        <label for="vch_tipo_sanguineo">Tipo Sanguíneo:</label>
        <input type="text" name="vch_tipo_sanguineo" id="vch_tipo_sanguineo" value="<?php echo $row_p['vch_tipo_sanguineo'] ?>">
        <label for="vch_telefone_contato">Telefone para contato de Emergência:</label>
        <input type="text" name="vch_telefone_contato" id="vch_telefone_contato" value="<?php echo $row_p['vch_telefone_contato'] ?>">
