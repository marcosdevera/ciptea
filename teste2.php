...
<head>
    ...
    <style>
        ...
        .line {
            ...
            height: 3px;
            background-color: green;
            top: 25px; /* Center the line vertically with the circles */
            left: 60px; /* Position the line to start after the circle */
            transition: width 1s;
        }
    </style>
</head>
<body>
    <div class="container">
        <div class="description text-center">
            <h1>Instructions</h1>
            <p>Follow the steps below to complete the process. Each step will unlock after you complete the previous one.</p>
        </div>
        <div class="circle-container">
            <div class="circle unlocked" id="circle1">1</div>
            <div class="line" id="line1"></div>
            <div class="text-container">
                <a href="#" class="step-link" data-target="#info1">Step 1: Description for step 1.</a>
                ...
                circle.addEventListener('click', function() {
                    if (circle.classList.contains('unlocked')) {
                        ...
                        if (index < circles.length - 1) {
                            ...
                            document.getElementById('line' + (index + 1)).style.width = '60px'; // Adjust width based on your design
                        }
                    }
                });
            });
